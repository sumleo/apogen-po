...
public class New1 {
    ...
    /**
		Page Object for New1 (state11) 
	*/
    public New1(WebDriver driver) {
        this.driver = driver;
    ...
    public ClassUnderTestApogen goToIndex_1() {
        a_Home.click();
        return new ClassUnderTestApogen(driver);
    }

    public void setA_All(String args0, String args1, String args2, String args3, String args4) {
